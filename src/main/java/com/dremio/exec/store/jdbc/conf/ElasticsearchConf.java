...
@SourceType(value = "ElasticsearchARP", label = "Elasticsearch",uiConfig = "elasticsearch-layout.json")
public class ElasticsearchConf extends AbstractArpConf<ElasticsearchConf> {
  private static final String ARP_FILENAME = "arp/implementation/elasticsearch-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.elasticsearch.ElasticsearchDriver";
